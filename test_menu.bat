...
if "%choice%"=="2" if exist "scripts/kpi_processor.py" python scripts/kpi_processor.py --mode baseline
if "%choice%"=="3" if exist "scripts/kpi_processor.py" python scripts/kpi_processor.py --mode targeted --kpi SM001
